                ...
                <div class="product-content-wrap">
                    ...
                    <nav class="product-teb-menu">
                        <ul class="nav justify-content-center" role="tablist">
                            <li><a class="active" href="#new-products" id="new-product-tab" data-bs-toggle="tab">Sản
                                    phẩm mới</a></li>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="category-product-wrap">
                        ...
                        <figure class="cat-banner">
                            <a href="shop.html"><img style="height: 280px;" src="assets_fontend/img/banner-laptop1.jpg"
                                    alt="Category"></a>
                        </figure>
                ...
                <div class="col-lg-6">
                    <div class="category-product-wrap">
                        <h4 class="cate-pro-title"><a href="shop.html">PHONE</a></h4>
                        <figure class="cat-banner">
                            <a href="shop.html"><img style="height: 280px;" src="assets_fontend/img/banner-laptop2.jpg"
                                    alt="Category"></a>
                        </figure>
                ...
                <div class="col-lg-6">
                    <div class="category-product-wrap">
                        <h4 class="cate-pro-title"><a href="shop.html">PHONE </a></h4>
                        <figure class="cat-banner">
                            <a href="shop.html"><img style="height: 249px;" src="assets_fontend/img/banner-laptop3.webp"
                                    alt="Category"></a>
                        </figure>
                ...
                <div class="col-lg-6">
                    <div class="category-product-wrap">
                        <h4 class="cate-pro-title"><a href="shop.html">PHONE</a></h4>
                        <figure class="cat-banner">
                            <a href="shop.html"><img height="250px" src="assets_fontend/img/banner-laptop4.webp"
                                    alt="Category"></a>
                        </figure>
